...
public:
    ...
    void loadFont(const string& font) {
        ...
        if (error)
            cout << "FT Error in setting pixel size : " << getErrorMessage(error) << "\n";
        ...
        for (unsigned char c = 32; c < totalCharacters; c++) {
            ...
            if (error)
                cout << "FT Error in loading character : " << getErrorMessage(error) << "\n";
            ...
            if (error)
                cout << "FT Error in rendering glyph : " << getErrorMessage(error) << "\n";
