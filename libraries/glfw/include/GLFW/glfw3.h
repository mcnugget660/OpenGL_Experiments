 ...
 *  window resize or rotate.  A compositor can still emit close, maximize or
 ...
 *
 *  __Do not use this function__ to rotate an already visible window unless you
 ...
 *
 *  On some platforms, a window rotate, resize or menu operation will cause event
